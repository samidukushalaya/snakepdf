...
var _getSnakeSize = Module['_getSnakeSize'] = makeInvalidEarlyAccess('_getSnakeSize');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['getWidth'] != 'undefined', 'missing Wasm export: getWidth');
  assert(typeof wasmExports['getHeight'] != 'undefined', 'missing Wasm export: getHeight');
  assert(typeof wasmExports['getSnakeSize'] != 'undefined', 'missing Wasm export: getSnakeSize');
  ...
  _getWidth = Module['_getWidth'] = createExportWrapper('getWidth', wasmExports['getWidth'], 0);
  _getHeight = Module['_getHeight'] = createExportWrapper('getHeight', wasmExports['getHeight'], 0);
  _getSnakeSize = Module['_getSnakeSize'] = createExportWrapper('getSnakeSize', wasmExports['getSnakeSize'], 0);
  _isGameOver = Module['_isGameOver'] = createExportWrapper('isGameOver', wasmExports['isGameOver'], 0);
